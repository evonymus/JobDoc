...
CREATE TABLE 'ENTY_SEL_CTA_T' ('ENTY_SEL_CTA_CD' TEXT,'OPT_LCK' NUMERIC
...
CREATE TABLE 'SCHD_DETL_T' ('SCHD_DETL_ID' NUMERIC,'OPT_LCK' NUMERIC,
...
CREATE TABLE 'ADTN_DATA_T' ('ADTN_DATA_ID' NUMERIC,'DATA' TEXT,'CRTD_DTT' TEXT,'ADTN_DATA_CD' TEXT,'ADTN_DATA_TYP_ENU' NUMERIC,'ACTV_YN' TEXT,'CRTD_USR_CD' TEXT,'UPDT_USR_CD' TEXT,'UPDT_DTT' TEXT,'TPLT_FMT_TYP_ENU' NUMERIC);
)SQL";
