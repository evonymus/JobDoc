...
class SchdDetl: public Poco::ActiveRecord::ActiveRecord<Poco::Int16>
{
public:
	...
	SchdDetl& opt_lck(Poco::Int16 value);

	Poco::Int16 rcurnce_typ_enu() const;
	SchdDetl& rcurnce_typ_enu(Poco::Int16 value);
	...
	const Poco::Nullable<Poco::Data::Date>& strt_dt() const;
	SchdDetl& strt_dt(const Poco::Nullable<Poco::Data::Date>& value);

	const Poco::Nullable<Poco::Data::Date>& end_tm() const;
	SchdDetl& end_tm(const Poco::Nullable<Poco::Data::Date>& value);

	const Poco::Nullable<Poco::Int16>& day_of_mth() const;
	SchdDetl& day_of_mth(const Poco::Nullable<Poco::Int16>& value);

	Poco::Int16 itvl() const;
	SchdDetl& itvl(Poco::Int16 value);

	Poco::Int16 fxd_itvl_src_enu() const;
	SchdDetl& fxd_itvl_src_enu(Poco::Int16 value);
...
private:
	...
	Poco::Int16 _rcurnce_typ_enu = 0;
	Poco::Nullable<Poco::Data::Date> _efct_dt;
	Poco::Nullable<Poco::Data::Date> _expd_dt;
	Poco::Nullable<Poco::Data::Date> _strt_dt;
	Poco::Nullable<Poco::Data::Date> _end_tm;
	Poco::Nullable<Poco::Int16> _day_of_mth;
	Poco::Int16 _itvl = 0;
	Poco::Int16 _fxd_itvl_src_enu = 0;
...
inline Poco::Int16 SchdDetl::opt_lck() const
{
	return _opt_lck;
}


inline SchdDetl& SchdDetl::opt_lck(Poco::Int16 value)
{
	_opt_lck = value;
	return *this;
}
...
inline Poco::Int16 SchdDetl::rcurnce_typ_enu() const
{
	return _rcurnce_typ_enu;
}


inline SchdDetl& SchdDetl::rcurnce_typ_enu(Poco::Int16 value)
{
...
inline const Poco::Nullable<Poco::Data::Date>& SchdDetl::strt_dt() const
{
	return _strt_dt;
}


inline SchdDetl& SchdDetl::strt_dt(const Poco::Nullable<Poco::Data::Date>& value)
{
	_strt_dt = value;
	return *this;
}
...
inline const Poco::Nullable<Poco::Int16>& SchdDetl::day_of_mth() const
{
	return _day_of_mth;
}


inline SchdDetl& SchdDetl::day_of_mth(const Poco::Nullable<Poco::Int16>& value)
{
	_day_of_mth = value;
	return *this;
}
...
inline Poco::Int16 SchdDetl::itvl() const
{
	return _itvl;
}


inline SchdDetl& SchdDetl::itvl(Poco::Int16 value)
{
	_itvl = value;
	return *this;
}
...
inline Poco::Int16 SchdDetl::fxd_itvl_src_enu() const
{
	return _fxd_itvl_src_enu;
}


inline SchdDetl& SchdDetl::fxd_itvl_src_enu(Poco::Int16 value)
{
...
public:
	...
	static void bind(std::size_t pos, const asarum::BY::SchdDetl& ar, AbstractBinder::Ptr pBinder, AbstractBinder::Direction dir)
	{
		...
		TypeHandler<Poco::Int16>::bind(pos++, ar._rcurnce_typ_enu, pBinder, dir);
		...
		TypeHandler<Poco::Nullable<Poco::Data::Date>>::bind(pos++, ar._strt_dt, pBinder, dir);
		TypeHandler<Poco::Nullable<Poco::Data::Date>>::bind(pos++, ar._end_tm, pBinder, dir);
		TypeHandler<Poco::Nullable<Poco::Int16>>::bind(pos++, ar._day_of_mth, pBinder, dir);
		TypeHandler<Poco::Int16>::bind(pos++, ar._itvl, pBinder, dir);
		TypeHandler<Poco::Int16>::bind(pos++, ar._fxd_itvl_src_enu, pBinder, dir);
	...
	static void extract(std::size_t pos, asarum::BY::SchdDetl& ar, const asarum::BY::SchdDetl& deflt, AbstractExtractor::Ptr pExtr)
	{
		...
		TypeHandler<Poco::Int16>::extract(pos++, ar._rcurnce_typ_enu, deflt._rcurnce_typ_enu, pExtr);
		...
		TypeHandler<Poco::Nullable<Poco::Data::Date>>::extract(pos++, ar._strt_dt, deflt._strt_dt, pExtr);
		TypeHandler<Poco::Nullable<Poco::Data::Date>>::extract(pos++, ar._end_tm, deflt._end_tm, pExtr);
		TypeHandler<Poco::Nullable<Poco::Int16>>::extract(pos++, ar._day_of_mth, deflt._day_of_mth, pExtr);
		TypeHandler<Poco::Int16>::extract(pos++, ar._itvl, deflt._itvl, pExtr);
		TypeHandler<Poco::Int16>::extract(pos++, ar._fxd_itvl_src_enu, deflt._fxd_itvl_src_enu, pExtr);
	...
	static void prepare(std::size_t pos, const asarum::BY::SchdDetl& ar, AbstractPreparator::Ptr pPrep)
	{
		...
		TypeHandler<Poco::Int16>::prepare(pos++, ar._rcurnce_typ_enu, pPrep);
		...
		TypeHandler<Poco::Nullable<Poco::Data::Date>>::prepare(pos++, ar._strt_dt, pPrep);
		TypeHandler<Poco::Nullable<Poco::Data::Date>>::prepare(pos++, ar._end_tm, pPrep);
		TypeHandler<Poco::Nullable<Poco::Int16>>::prepare(pos++, ar._day_of_mth, pPrep);
		TypeHandler<Poco::Int16>::prepare(pos++, ar._itvl, pPrep);
		TypeHandler<Poco::Int16>::prepare(pos++, ar._fxd_itvl_src_enu, pPrep);
